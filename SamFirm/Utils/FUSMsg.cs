                ...
                new XElement("FUSMsg",
                    ...
                    new XElement("FUSBody",
                        new XElement("Put",
                            ...
                            // Additional fields from FOTA Agent analysis
                            new XElement("DEVICE_TYPE_CODE",
                                new XElement("Data", "PHONE DEVICE")),
                            new XElement("TERMS",
                                new XElement("Data", "Y")),
                            new XElement("TERMS_VERSION",
                                new XElement("Data", "3.0")),
                            new XElement("LDU_FLAG",
                                new XElement("Data", "LDU")),
